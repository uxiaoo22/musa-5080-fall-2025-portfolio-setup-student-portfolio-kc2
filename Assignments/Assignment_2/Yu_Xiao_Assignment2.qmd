...
# Quick visualization
tmap_mode("view")
tm_shape(bike_buffer) + tm_borders(col = "steelblue") +
  tm_shape(school_buffer) + tm_borders(col = "red") +
  tm_shape(crime) + tm_dots(col = "black", size = 0.05) +
  tm_layout(title = "School and Bike Lane Buffers with Crime Points")
...
tmap_mode("view")
tm_shape(bike_network) + tm_lines(col = "steelblue") +
  tm_shape(school_buffer) + tm_borders(col = "firebrick") +
  tm_shape(at_risk_schools) + tm_dots(col = "black", size = 0.3) +
  tm_layout(title = "At-Risk Schools: High Crime and No Nearby Bike Lanes")
